...
@section('content')
  ...
  @csrf
    ...
    <input type="text" name="coordinatorContactNo" id="coordinatorContactNo" class=" block w-full  border-gray-300 rounded-md"style="height:40px;" placeholder="{{ $items->coordinatorContactNo }}"required><br>

    <label for="coordinatorEmail" class="block text-sm font-medium text-gray-700">Coordinator Email Address </label>
    <input type="text" name="coordinatorEmail" id="coordinatorEmail" class=" block w-full  border-gray-300 rounded-md"style="height:40px;" placeholder="{{ $items->coordinatorEmail }}"required><br>

    <label for="expertise" class="block text-sm font-medium text-gray-700">Expertise </label>
    <input type="text" name="expertise" id="expertise" class=" block w-full  border-gray-300 rounded-md"style="height:40px;" placeholder="{{ $items->expertise }}"required><br>
