...
@section('content')
  ...
  @csrf
    ...
    <input type="text" name="lecturerContactNo" id="lecturerContactNo" class=" block w-full  border-gray-300 rounded-md"style="height:40px;" placeholder="{{ $items->lecturerContactNo }}"><br>

    <label for="lecturerEmail" class="block text-sm font-medium text-gray-700">Lecturer Email Address </label>
    <input type="text" name="lecturerEmail" id="lecturerEmail" class=" block w-full  border-gray-300 rounded-md"style="height:40px;" placeholder="{{ $items->lecturerEmail }}"><br>

    <label for="superviseeName" class="block text-sm font-medium text-gray-700">Supervisee Name </label>
    <input type="text" name="superviseeName" id="superviseeName" class=" block w-full  border-gray-300 rounded-md"style="height:40px;" placeholder="{{ $items->superviseeName }}"><br>
